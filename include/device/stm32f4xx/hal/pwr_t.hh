...
namespace hal {
    ...
    using pwr_control_pls =
        ...
        pwr_control_pls_t,
        3,
        pwr_control_pls_t::l2_0v>;
    using pwr_control_dbp = lib::regbit<8>;
    using pwr_control_fpds = lib::regbit<9>;
    using pwr_control_vos = lib::regbit<14>;
    ...
    using pwr_control_status_ewup = lib::regbit<8>;
    using pwr_control_status_vosrdy = lib::regbit<14>;
